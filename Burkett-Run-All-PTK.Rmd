---
title: "Mouse Empathy Dataset - Combined - PTK"
...
params:
  ...
  signal_file_r1: "kinome_data/PTK/EXP01_KRSAsOutput_Median_SigmBg_231117142535-PTK.txt" # Change the file name to the one you have
  saturation_file_r1: "kinome_data/PTK/EXP01_KRSAsOutput_Signal_Saturation_231117142536-PTK.txt" # Change the file name to the one you have
  signal_file_r2: "kinome_data/PTK/EXP02_KRSAsOutput_Median_SigmBg_231117143358-PTK.txt" # Change the file name to the one you have
  saturation_file_r2: "kinome_data/PTK/EXP02_KRSAsOutput_Signal_Saturation_231117143400-PTK.txt" # Change the file name to the one you have
  signal_file_r3: "kinome_data/PTK/EXP03_KRSAsOutput_Median_SigmBg_231117144020-PTK.txt" # Change the file name to the one you have
  saturation_file_r3: "kinome_data/PTK/EXP03_KRSAsOutput_Signal_Saturation_231117144021-PTK.txt" # Change the file name to the one you have
...
raw_data_r1 <- krsa_read(
  signal_file = params$signal_file_r1,
  signal_saturation = params$saturation_file_r1
)

raw_data_r2 <- krsa_read(
  signal_file = params$signal_file_r2,
  signal_saturation = params$saturation_file_r2
)

raw_data_r3 <- krsa_read(
  signal_file = params$signal_file_r3,
  signal_saturation = params$saturation_file_r3
)

raw_data <- bind_rows(raw_data_r1, raw_data_r2, raw_data_r3)
...
pdf("combined_heatmap.pdf", width = 8.5, height = 11, bg = "white")
krsa_heatmap_grouped(data_modeled$grouped, clean_peptides, scale = "row")
dev.off()
