...
params:
  ...
  signal_file: "kinome_data/Run2_KRSAsoutput_Median_SigmBg_230714113751.txt" # Change the file name to the one you have
  saturation_file: "kinome_data/Run2_KRSAsoutput_Signal_Saturation_230714113752.txt" # Change the file name to the one you have
