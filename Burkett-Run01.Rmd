...
params:
  ...
  signal_file: "kinome_data/Run1_KRSAsOutput_Median_SigmBg_230714112932.txt" # Change the file name to the one you have
  saturation_file: "kinome_data/Run1_KRSAsOutput_Signal_Saturation_230714112932.txt" # Change the file name to the one you have
