...
pdf("combined_krsa_zscores.pdf", width = 8.5, height = 11, bg = "white")
AvgZTable2 |> ungroup() |> filter(abs(AvgZ) >= 1) |> krsa_zscores_plot()
dev.off()
...
krsa_reverse_krsa_plot(chipCov, differential_phosphorylated_peptides, c("PKCH", "PAKB", "PKN", "MLCK", "ERK", "BRSK", "PIM", "RAD53", "WNK", "HAL"), 0.2, byChip = FALSE)
```
