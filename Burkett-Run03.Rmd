...
params:
  ...
  signal_file: "kinome_data/Run3_KRSAsOutput_Median_SigmBg_230714115014.txt" # Change the file name to the one you have
  saturation_file: "kinome_data/Run3_KRSAsOutput_Signal_Saturation_230714115014.txt" # Change the file name to the one you have
