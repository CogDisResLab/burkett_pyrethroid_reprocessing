---
title: "Mouse Empathy Dataset - Combined - STK"
...
params:
  ...
  signal_file_r1: "kinome_data/STK/Run1_KRSAsOutput_Median_SigmBg_230714112932.txt" # Change the file name to the one you have
  saturation_file_r1: "kinome_data/STK/Run1_KRSAsOutput_Signal_Saturation_230714112932.txt" # Change the file name to the one you have
  signal_file_r2: "kinome_data/STK/Run2_KRSAsoutput_Median_SigmBg_230714113751.txt" # Change the file name to the one you have
  saturation_file_r2: "kinome_data/STK/Run2_KRSAsoutput_Signal_Saturation_230714113752.txt" # Change the file name to the one you have
  signal_file_r3: "kinome_data/STK/Run3_KRSAsOutput_Median_SigmBg_230714115014.txt" # Change the file name to the one you have
  saturation_file_r3: "kinome_data/STK/Run3_KRSAsOutput_Signal_Saturation_230714115014.txt" # Change the file name to the one you have
